...
/** 打码闸门那一道。返回的是失败清单（空 = 绿）。 */
export async function verifyRedaction(lane, options = {}) {
  const { seat = 0, budgetMs = 120000, keep = null } = options;
  ...
  if (problems.length > 0) return failure("打码闸门没过：", problems);
