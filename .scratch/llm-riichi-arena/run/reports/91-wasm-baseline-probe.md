...
座位 0 的配牌是 `1m1m 2m3m4m 5m6m7m 2p3p4p 5p6p`——**已经听牌**：后半连着是 `23456p`，
听的是 **1p/4p/7p 三面听**（`234p+56p` 等 4p/7p，`456p+23p` 等 1p/4p）。
**原报告把它写成「4p/7p 两面」，是主人看出来的，引擎复核在 `scripts/fsi/wait-check.fsx`。**
