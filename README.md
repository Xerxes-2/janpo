...
![首页截图：一局录下来的对局在自动回放，围观视角坐在座位 0](docs/images/home.png)

首页：Demo 牌谱自动回放，控制条只有播 / 暂停、从头再放与倍速。

![牌桌截图：`?table=1`，围观视角坐在座位 0，种子 1177 走了 52 手](docs/images/table.png)

主持人那一页（`?table=1`）：围观视角（座位 0）下的牌桌，四家围坐——**自家在下、下家在右、对家在上、上家在左**，
...
6. 按 **播放** 让它自己打下去，或 **单步** 一手一手看；**视角**按钮在围观视角与上帝视角之间切。
