...
#
# **前六道各是一条命令，后十六趟合成一条 + 强 AI 基线自起一条**（票 56、92）：它们从前各起一个 node 进程、一个 vite
...
if [[ "$NO_BROWSER" == "1" ]]; then
  echo "== 浏览器里那十六趟 + 强 AI 基线那一趟（曳光弹对拍 / 首页回放 / 牌桌八项 / 黄金用例 / 牌谱导出两趟 / 两道 key 闸门 / 分享载荷两趟 / 配桌三项开关 / 四 LLM 同桌 / 思考气泡 / 牌谱从外面进来的两条路 / 真人坐席 / ToolSearch 工具链路｜强 AI 基线四趟）：按 JANPO_NO_BROWSER=1 跳过 =="
else
